...
\begin{figure}[H]
    ...
    \label{fig:chart-shr}
\end{figure}
Rata-rata penggunaan shared memory pada prosesor ARM adalah 56325,57 KiB dan 54030,80 KiB pada FPGA. Terlihat bahwa penggunaan shared memory pada prosesor ARM sedikit lebih banyak daripada FPGA. Penggunaan shared memory terbesar pada prosesor ARM yaitu pada kernel gaussian blur 56503,60 KiB dan kernel laplacian 55528,80 KiB pada FPGA. Penggunaan shared memroy terkecil pada prosesor ARM yaitu pada kernel average blur 56157,40 KiB dan kernel laplacian 42568 KiB pada FPGA.
