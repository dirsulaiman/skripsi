...
%         \centering
%         \includegraphics[width=0.9\linewidth]{images/chart/chart-time50.png}
%         \caption{50 frame.}
%         \label{fig:chart-time50}
%     \end{subfigure}
%     \begin{subfigure}{0.5\textwidth}
%         \centering
%         \includegraphics[width=0.9\linewidth]{images/chart/chart-time200.png}
%         \caption{200 frame.}
%         \label{fig:chart-time200}
%     \end{subfigure}
%     \caption{Grafik perbandingan waktu komputasi dengan 50 frame dan 200 frame}
...
\begin{figure}[H]
    ...
    \label{fig:chart-shr}
\end{figure}
Rata-rata penggunaan shared memory pada prosesor ARM adalah 56325,57 KiB dan 54030,80 KiB pada FPGA. Terlihat bahwa penggunaan shared memory pada prosesor ARM sedikit lebih banyak daripada FPGA. Penggunaan shared memory terbesar pada prosesor ARM yaitu pada kernel gaussian blur 56503,60 KiB dan kernel laplacian 55528,80 KiB pada FPGA. Penggunaan shared memory terkecil pada prosesor ARM yaitu pada kernel average blur 56157,40 KiB dan kernel laplacian 42568 KiB pada FPGA.
...
\end{figure}
Rata-rata penggunaan VIRT pada prosesor ARM adalah 395407,64 KiB dan 395501,33 pada FPGA. Rata-rata penggunaan VIRT pada FPGA sedikit lebih tinggi dari pada prosesor ARM. Penggunaan VIRT terbesar pada prosesor ARM yaitu pada kernel gaussian blur 398862,80 KiB dan kernel laplacian 395638,40 KiB. Penggunaan VIRT terkecil pada prosesor ARM yaitu pada kernel 393544,80 KiB dan kernel sobel vertical 395385,60 KiB pada FPGA.
